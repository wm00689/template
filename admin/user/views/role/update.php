                ...
                <div class="widget-body">
                    <div id="horizontal-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="RoleForm[name]" value="<?= $model->name?>" class="form-control" id="name" placeholder="名称">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="RoleForm[description]" value="<?= $model->description?>" class="form-control" id="mobile" placeholder="描述">
                            ...
                            <div class="form-group">
                                ...
                                <?php foreach($permissions as $permission):?>
                                    <div class="col-sm-3">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="permission[]" value="<?= $permission->name?>" class="colored-success" <?php if(in_array($permission->name,$ps)) echo 'checked'?>>
                            ...
                            <div class="form-group">
                                ...
                                <?php foreach($roles as $role):?>
                                    <div class="col-sm-3">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="role[]" value="<?= $role->name?>" class="colored-success" <?php if(in_array($role->name,$rs)) echo 'checked'?>>
