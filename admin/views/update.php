                            ...
                            <div class="form-group">
                                ...
                                <?php foreach($permissions as $permission):?>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="permission[]" value="<?= $permission->name?>" class="colored-success" <?php if(in_array($permission->name,$assignments)) echo 'checked'?>>
                            ...
                            <div class="form-group">
                                ...
                                <?php foreach($roles as $role):?>
                                    <div class="col-sm-3">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="role[]" value="<?= $role->name?>" class="colored-success" <?php if(in_array($role->name,$assignments)) echo 'checked'?>>
